...
vec3 StarLayer(vec2 uv, float starSpeed, float density, float hueShift, float saturation, float twinkleIntensity, float time, float speed, float glowIntensity) {
  vec3 col = vec3(0.0);
...
void main() {
  ...
  for (float i = 0.0; i < 1.0; i += 1.0 / NUM_LAYER) {
    ...
    col += StarLayer(uv * scale + i * 453.32, uStarSpeed, uDensity, uHueShift, uSaturation, uTwinkleIntensity, uTime, uSpeed, uGlowIntensity) * fade;
  }
